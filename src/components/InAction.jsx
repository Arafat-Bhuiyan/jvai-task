...
const InAction = () => {
  return (
    <div>
      <section
        id="inAction"
        className="py-12 md:py-16 px-10 min-h-96 bg-[#1e293b]"
      >
        ...
        <div className="max-w-[1000px] leading-loose mx-auto">
          <div className="max-w-[1000px] relative shadow-[0_4px_15px_rgba(0,0,0,0.2)] text-[#f8fafc] leading-[1.6] my-5 mx-auto rounded-[10px] overflow-hidden bg-[#1e293b]">
            <div className="flex bg-slate-900/90 relative z-[30] border-b border-[rgba(148, 163, 184, .2)]">
              <div className="cursor-pointer text-center bg-slate-900/90 text-[#94a3b8] font-semibold px-5 py-[15px] transition duration-300 flex-[1_1_0%] border-r border-[rgba(148, 163, 184, .2)]">
                TranscriptX
              </div>
              <div className="cursor-pointer text-center bg-slate-900/90 text-[#94a3b8] font-semibold px-5 py-[15px] transition duration-300 flex-[1_1_0%] border-r border-[rgba(148, 163, 184, .2)]">
                Chartwright
